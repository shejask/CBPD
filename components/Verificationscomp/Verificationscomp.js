...
const Verificationscomp = () => {
    ...
    const verifyStudent = () => {
        const { regNumber, certNumber, learnerNumber } = formData;
        if (regNumber === 'ARCG1021' && certNumber === '3261' && learnerNumber === '68') {
    ...
    const verifyMember = () => {
        ...
        if (memberName.toLowerCase() === 'najeeb' && memberNumber === 'CBPD 001KL10') {
            ...
            <div className={styles.formContainer}>
                ...
                {centreResult && (
                    <div className={styles.verified}>
                        ...
                        <ul>
                            <li>Centre Code: KL/101421/25</li>
                            <li>Location: Calicut, Kerala</li>
                            <li>Name of Affiliated Centre: Create Plus</li>
                            <li>Expiry Date: 31-10-2025</li>
                        </ul>
                    </div>
                )}
            </div>
