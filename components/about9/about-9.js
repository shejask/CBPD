                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-xl-7 offset-xl-1 col-lg-8">
                        <div className="team-single-content">
                            ...
                            <p>Central Board of Professional Development (CBPD) offers a diverse range of courses across multiple disciplines, developed and delivered through 
                                well-structured partnerships with accredited education providers. Course allocation is 
                                determined based on institutional requirements and the availability of necessary 
                                infrastructure. Each program is expertly designed to match students' 
